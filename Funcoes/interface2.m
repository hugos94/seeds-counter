...
labels = {'Imagem Original';'Detecção de Bordas';'Fechamento';'Remoção de Componente Conectada';'Preenchimento';'Remoção de Componente Conectada';'Classificação';'Imagem Original'};
