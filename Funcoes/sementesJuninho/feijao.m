function feijao()
    ...
    arquivoMaiorEixo = fopen(['..\..\Imagens\Sementes Individuais\Juninho\Feijao\tamanhoDoMaiorEixo.txt'],'wt');
    arquivoArea = fopen(['..\..\Imagens\Sementes Individuais\Juninho\Feijao\area.txt'],'wt');
    arquivoCorR = fopen(['..\..\Imagens\Sementes Individuais\Juninho\Feijao\corR.txt'],'wt');
    arquivoCorG = fopen(['..\..\Imagens\Sementes Individuais\Juninho\Feijao\corG.txt'],'wt');
    arquivoCorB = fopen(['..\..\Imagens\Sementes Individuais\Juninho\Feijao\corB.txt'],'wt');
    ...
    destinoEntrada = ['..\..\Imagens\Sementes Individuais\Juninho\Feijao\'];
    
    destinoSaida = ['..\..\Imagens\Sementes Individuais\Juninho\Feijao\BandasDeCores\'];
    
    mostrarBandasDeCoresVariasImagens(destinoEntrada,destinoSaida,1,qtImagens);

    for i = 1:qtImagens
        
        imFeijao = imread(['..\..\Imagens\Sementes Individuais\Juninho\Feijao\' num2str(i) '.png']);
...
%         imprimeEixos(Propriedades,imMenosRuidosa);
        ...
        imwrite(imMenosRuidosa,['..\..\Imagens\Sementes Individuais\Juninho\Feijao\m' num2str(i) '.png']);
