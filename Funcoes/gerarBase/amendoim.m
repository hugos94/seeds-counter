function amendoim()
    ...
    arquivoMaiorEixo = fopen(['../../Imagens/Sementes Individuais/Amendoim/tamanhoDoMaiorEixo.txt'],'wt');
    arquivoArea = fopen(['../../Imagens/Sementes Individuais/Amendoim/area.txt'],'wt');
    arquivoCorR = fopen(['../../Imagens/Sementes Individuais/Amendoim/corR.txt'],'wt');
    arquivoCorG = fopen(['../../Imagens/Sementes Individuais/Amendoim/corG.txt'],'wt');
    arquivoCorB = fopen(['../../Imagens/Sementes Individuais/Amendoim/corB.txt'],'wt');
    ...
    destinoEntrada = ['..\..\Imagens\Sementes Individuais\Amendoim\'];
    
    destinoSaida = ['..\..\Imagens\Sementes Individuais\Amendoim\BandasDeCores\'];
